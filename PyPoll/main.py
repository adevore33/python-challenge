...
output_path = r'C:\Users\austi\OneDrive\Desktop\python-challenge\PyPoll\analysis\pypoll_analysis.txt'
with open(output_path, "w") as txtfile:
    txtfile.writelines(f"Election Results\n-----------------------\n Total Votes {rowcount}\n -----------------------\n Charles Casper Stockham {percent_charles: .3%}, ({charles_votes})\n Diana DeGette  {percent_diana: .3%}, ({diana_votes})\n Raymon Anthony Doanne  {percent_raymon: .3%}, ({raymon_votes})\n -----------------------\n {winner}")